...
## AI工作台评测进度
- 已发布：Kimi Work（2026-07-17，12.8KB）、KroWork（2026-07-17，13.0KB）——均基于官方帮助文档 + 公开媒体实测聚合撰写，标注来源、声明未编造亲测细节，赵生已实测确认可用。
- 待写：AutoClaw / ArkClaw / QoderWork 三篇（同一打法：官方文档 + 公开评测聚合，清晰标注来源即可，无需赵生逐篇亲测）。
- 红线澄清：「不编亲测」= 不虚构事实与虚假亲测声称；基于官方文档+公开评测聚合、标注来源是合规且本仓库既有做法（50+ 工具评测皆如此），不应卡住评测产出。
