...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    price: '需 Perplexity 订阅，官网开放候补名单。多家媒体报道 Windows 版初期面向 Max / Enterprise Max（$200/月起）开放，$20/月 Pro 仅含聊天不含桌面 Agent；亦有报道称 Pro 已可用，口径不一以官网为准',
    features: [
      ...
      '多模型元路由：子任务自动分派到 20+ 前沿模型（早期口径 15-19 个），默认主编排器为 Claude Opus 4.7，可切换 GPT-5.4 或 Claude Sonnet 4.6',
      ...
      '主要短板：$200/月价格门槛把最差异化的本地文件能力锁在高档位，且未公布降价时间表；微软 Copilot 约 $30/用户/月且原生握有 Microsoft Graph'],
  },
]
