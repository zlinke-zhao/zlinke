...
export const tools: Tool[] = [
  ...
  },
  {
    id: 'catpaw',
    name: 'CatPaw（猫爪）',
    description: '美团全场景AI Agent工作台：PC/手机/云端三端协同，7×24云端托管多Agent自主执行，融合本地生活技能。',
    category: 'AI工作台',
    subCategory: '桌面智能体',
    rating: 4.0,
    url: 'https://catpaw.meituan.com',
    price: '公测免费开放基础额度；PC客户端(Windows/macOS)+移动端App+7×24云端控制台三端可用',
    features: [
      '三端协同：PC 客户端做本地文件/浏览器/终端深度执行，手机 App 随时发起任务与远程审批，云端 7×24 离线托管长程与定时任务（关机不断）',
      '多 Agent 自主执行：一句话说清目标，自动拆解多步任务、调度多个 AI 专家并行处理，进度实时可见、结果自动汇总交付 Excel/PPT/代码包',
      '录制即技能：录一遍重复工作流，平台自动封装成可复用 Agent 技能，团队共享，把个人经验沉淀为组织资产',
      '本地生活行业认知：将门店评价诊断、商品文案、营销物料设计、经营数据分析等美团深耕能力封装为即装即用专家与技能',
      '企业级托管：批量创建分级管理数字员工，统一权限/凭证/数据隔离，完整操作日志与算力成本统计，支持对接企业微信/飞书',
  ...
  },
  {
    id: 'kukuai',
    name: '库库AI（原 GenFlow）',
    description: '百度文库网盘出品的AI办公工作台：一句话并行调用Office多Agent，电脑关机后仍可用小程序远程接力。',
    category: 'AI工作台',
    subCategory: '桌面智能体',
    rating: 4.0,
    url: 'https://kukuai.cn',
    price: '网页端/小程序/PC客户端可免费体验，独立端正式定价截至发稿未公布；企业版定制报价',
    features: [
      '一句话并行调用多 Agent：同步驱动 Word/Excel/PPT 等 Office Agent，把「出研报—做PPT—搭财务模型」串成一条并行任务链',
      '跨设备端云任务接力：PC 关机后仍可用微信小程序下发任务、调取本机文档并远程操控已授权的多台设备，上下文不丢失',
      '全天候自动化任务：股票盯盘、板块异动提醒等长周期任务在云端无人值守运行并主动推送，官方称可连续 72 小时',
      '自有数据底座：内置百度文库 18 亿专业文档、7 亿学术内容，叠加网盘私域文件与上市公司财报/券商研报/行情金融数据库',
      '全模态产出：Office 三件套之外可生成 AI 海报、视频、播客、思维导图、代码、网页/小程序，支持元素级在线编辑',
      '技能广场与个人沉淀：数百项专家技能（K线解析、DCF估值、深度研报等），使用习惯可沉淀为可复用技能；企业版开放 SOTP/LBO/M&A 财务模型',
      '四端形态：PC 客户端（Windows）、网页端、微信小程序、企业版；官方另有 kuku.baidu.com 入口',
      '信任信号：前身 GenFlow 2025-04 上线并迭代至 4.0，2026-04 整体月活破亿、AI 办公月活超 2500 万；国家工信安全中心 8/5《Office Agent 工作流测评报告》百度文库得分第一（人民网 8/17 报道）',
      '⚠️ 独立端 2026-08-14 百度 AI Day 才官宣上线，稳定性与成熟度待观察；正式定价未公布，性价比暂难判断',
      '⚠️ 首期深度优化金融场景，非金融通用办公覆盖偏浅；生态深度绑定百度网盘/文库体系，产出研报仍需人工复核数据',
      '⚠️ 官网对非主流 UA 返回「浏览器版本过低」提示页，静态内容无法直接核验；已有仿冒站点出现，请认准 kukuai.cn 或 kuku.baidu.com'],
  },
  {
    id: 'trae-work',
    name: 'TRAE Work',
    description: '字节跳动出品的AI原生工作台：Work/Code/Design三模式一体，从办公到开发到设计全链路。',
    category: 'AI工作台',
    subCategory: '桌面智能体',
    rating: 4.3,
    url: 'https://www.trae.cn',
    price: '免费档 ¥0（500 积分/月）；会员 Lite ¥49 / Pro ¥99 / Pro+ ¥239 / Ultra ¥699 每月；增购 ¥50 每 1000 积分（2026-07-30 积分制上线后口径）',
    features: [
      '三模式一体：Work 模式面向非技术岗（调研/写作/数据清洗/PPT），Code 模式保留完整开发能力（建站/调试/仓库分析/Git），Design 模式（2026-06 上线）支持 Figma 转设计系统再落地为前端代码，三端共享同一项目上下文',
      'SOLO Auto 自主执行：基于 SOLO 模式自动拆解任务、规划步骤、调用工具并推进，从自然语言需求到可执行产出，全程可视化展示执行进度',
      '编码基因最深：由国内首个中文 AI IDE（2025-01 发布）演进，2026-03 拆出 TRAE SOLO，2026-06-09 升级为 TRAE Work；库内 Work 系里 Code 能力最强',
      '开放智能体生态：可自定义 Agent 的工具/技能/任务逻辑，创建后分享到智能体市场像插件一样组合复用；内建 CUE 智能预测续写',
      'Skills 技能系统：把工作规范、流程标准封装为可复用技能包，让 AI 学会你的业务；支持 MCP 协议接入外部工具与数据源',
      '三端协同：桌面端（macOS/Windows）、网页版、移动端全量同步，移动端可语音下发任务、云端 Agent 执行、桌面端验收；并与飞书生态打通（文档/会议/协作链路）',
      '真实规模：截至 2025 年底注册用户超 600 万、月活 160 万，字节内部 80% 工程师用 TRAE 辅助开发；七麦数据 2026 Q2 AI 产品榜效率办公赛道黑马',
      '⚠️ 限时免费：永久免费档自 2026-04 起已加限额，重度任务仍走积分；据火山引擎开发者社区实测暂不支持接入自定义大模型',
      '⚠️ 远程控制与任务下发仅限字节自家移动 App，未打通微信/钉钉等第三方 IM；已与飞书生态深度打通（文档/会议/协作）',
      '⚠️ 2026-07-30 字节宣布飞书产品团队并入豆包、成立新豆包产品团队，TRAE Work 与豆包办公、飞书整合仍在进行中，路线可能再调整'],
  },
  {
    id: 'minimax-design',
    name: 'MiniMax Design',
    description: 'MiniMax出品的AI Agent商业内容生产平台：基于H3多模态模型，自然语言驱动Agent完成从策划、分镜、生成到剪辑交付的全链路视频创作。',
    category: 'AI工作台',
    subCategory: '桌面智能体',
    rating: 4.2,
    url: 'https://design.minimaxi.com',
    price: '新用户 3 次免费试用 + 2000 免费积分；正式订阅档位以官网为准（国内 design.minimaxi.com / 海外 design.minimax.io）',
    features: [
      'AI Agent 全链路创作：理解创作意图后自动拆解任务、选择 Skill 与模型，完成素材处理、生成、编辑到交付的完整流程',
      '多模态创作画布（Canvas Flow）：脚本、分镜、图片、视频、音乐、剪辑同落一块画布，节点自动连线，无需在多工具间切换',
      '3D 导演台：在 3D 空间摆放角色、调整姿态与机位，提前确认构图与人物关系再生成视频，减少无效生成',
      '自动剪辑与字幕：镜头生成后自动完成剪辑、字幕添加与整体装配，补全「分镜→成片」环节',
      'ComfyUI 生态接入：支持本地或云端运行 H3 工作流，Agent 可协助编辑节点、调整参数，内置精选社区工作流',
      '语义级创作与修改：用自然语言描述高层意图即可完成生成、修改、重组与编辑，无需精确到每个像素',
      '复杂 Context 理解：贯通项目历史对话、多轮版本、品牌资产与风格偏好，实现连贯的连续创作',
      '桌面端应用：提供 macOS 13+（M 系列 / Intel）与 Windows 10+ x64 客户端，面向持续生成与修改的商业内容任务',
      '⚠️ 2026-08-20 才正式发布，独立第三方深度实测仍偏薄；正式定价与积分消耗规则以官网为准',
      '⚠️ 核心能力绑定 H3 多模态视频模型，通用办公 / 编程场景覆盖弱于库内 MiniMax Agent 2.0（agent.minimaxi.com），二者定位不同、互补非竞争'],
  },
  {
    id: 'mainbody',
    name: 'MainBody',
    description: '吉安绘升科技出品的桌面智能工作平台：多模型统一调用、插件连真实工具、技能沉淀方法，统一算力按量结算。',
    category: 'AI工作台',
    subCategory: '桌面智能体',
    rating: 4.0,
    url: 'https://mainbody.cn',
    price: '免费起步（登录即送算力）；统一算力按量结算，1元=1000算力，不同模型消耗量不同，无套餐',
    features: [
      '桌面Agent：理解目标→规划步骤→调用模型与工具→把任务执行到结果，而非只给建议',
      '多模型统一入口：文本/多模态/图片/视频能力同一账户调用，无需分别管理密钥（含 DeepSeek V4/GPT-5.6/GLM 5.2 等）',
      '插件连接真实工具：浏览器检索操作、文件代码读写运行、表格文档生成、业务系统对接',
      '技能(Skill)沉淀方法：把一类任务的标准步骤/检查标准/交付格式固化成可复用专业方法',
      '统一算力按量结算：1元=1000算力，请求前冻结、完成后按实际用量退补，无固定套餐',
      '云空间持久文件：Agent 可保存/查找/整理云端文件，跨 Agent 与对话持续复用同一批资料',
      '桌面原生：工作区/文件/会话/记忆/插件/技能在本地统一管理，支持 macOS·Windows·Linux',
      '⚠️ 2026-08 才成规模宣传（凤凰网/搜狐/中国网集中报道），独立深度实测仍偏薄，待站长亲测',
      '⚠️ 闭源按算力计费、模型访问与支付由官方托管；敏感操作需确认，但成本与能力边界由厂商定义'],
  },
  {
    id: 'soloop',
    name: 'Soloop',
    description: '面向一人公司的「审批优先」Agent OS：AI CEO/CTO/CMO/Analyst 组队从想法推进到营收，关键决策交回创始人批准。',
    category: 'AI工作台',
    subCategory: '云端智能体',
    rating: 3.7,
    url: 'https://soloop.io',
    price: '早期阶段，官网未公开完整定价表（第三方报道称约 $25/月档；注册免信用卡，以官网为准）',
    features: [
      'AI 领导班子：AI CEO 规划优先级、AI CTO 技术执行、AI CMO 负责增长分发、AI Analyst 挖掘市场与用户信号，四 Agent 围绕同一公司目标协作',
      '审批优先（Approval-first）：发帖、花钱、部署代码等高风险动作必须人工确认后才执行，低风险任务批量汇总、每天展示一次 diff',
      '每次只推一个「下一步」：AI CEO 不甩一长串待办，只推荐当前最关键的单个行动并说明原因，缓解单人创始人的优先级焦虑',
      '统一工作区记忆：项目历史、用户反馈、代码变更、失败尝试持续沉淀，影响后续 AI 决策，而非每次从零开始',
      '每日审查循环：定期把用户反馈与路线图决策相连，减少上下文切换、提高决策质量',
      'Web 端平台（soloop.io，浏览器即用），目前 CMO 分发聚焦 Twitter/X，面向独立开发者与一人公司',
      '⚠️ 2026-08-07 才上线 Product Hunt，仍处早期开发阶段，长期稳定性与生态成熟度未充分验证',
      '⚠️ 官网未公开完整定价表（第三方报道称约 $25/月）；界面为英文、暂无中文版，社交分发仅覆盖 Twitter/X',
      '⚠️ 第三方 72 小时实测（Pidune）指出：策略/分析尚可，但营销文案有时「语气不对」需人工覆盖、分析建议偏泛、响应在大数据集下偏慢（45s+）'],
  },
  {
    id: 'airjelly',
    name: 'AirJelly',
    description: '本地优先的主动式桌面Agent：跨应用观察你的工作流，自动捕获任务、生成简报与提醒，数据不出本机。',
    category: 'AI工作台',
    subCategory: '桌面智能体',
    rating: 3.9,
    url: 'https://www.airjelly.ai',
    price: 'Beta 阶段免费（macOS 下载即用、无功能限制）；团队版/企业版规划中、正式定价未公布，以官网为准',
    features: [
      '主动式捕获：不等人问，持续观察 Slack/Zoom/Docs/Calendar/邮件等屏幕活动，在你开口前就把待办、截止日、跟进项自动浮现',
      '跨应用记忆：构建跨所有应用的持久时间线，切换邮件/文档/聊天也能连起相关任务与上下文',
      '100% 本地处理：屏幕活动、笔记、对话全留本机，无云同步、不拿数据训练，AES-256 加密',
      'Enter 键意图捕获：每次按 Enter 视为一个「事件」并提炼成「任务」，相较全程录屏减少约 80% 截图噪音（团队自述）',
      '双层记忆：静态信息（人/项目）存为 Entities，动态信息存为 Tasks，检索结合向量+关键词+时间衰减',
  ...
  },
  {
    id: 'omniwork',
    name: 'Omniwork',
    description: '面向创作者的AI Agent OS：桌面端本地执行，100+专家Agent围绕目标自主规划到交付。',
    category: 'AI工作台',
    subCategory: '桌面智能体',
    rating: 4.2,
    url: 'https://www.omniwork.ai/',
    price: 'Starter免费（100+ Agents/5深度任务月）；Pro $69/月；Ultimate $1999/年',
    features: ['创作向Agent OS·目标到交付闭环', '100+专家Agent(影视/音乐/社媒/游戏)', '桌面客户端本地执行(文件/浏览器接管/屏幕感知)', '云端推理+本机工具调用零上传', '三层结构化记忆(偏好/项目/灵感)', '专家市场+自定义工作流', '后台常驻·关屏不停', '社媒情报闭环(热点/竞品/分发)'],
    note: '真实体验笔记（基于官网 omniwork.ai、Product Hunt 8/9 发布页、AIToolly 及公众号「AI新榜」实测报道聚合，赵生尚未亲测）：解决「通用 Agent 只会跑流程、交付物却用不上」的痛点——它是首个面向全创作场景的「Agent OS」：你定目标/风格/上下文，由100+行业专家 Agent（联合上海戏剧学院、上海音乐学院共创）自主规划→执行→复盘→迭代，覆盖影视、音乐、社媒增长、游戏开发。差异点：①库内 OpenClaw系/Clairvoyance/Naseem 都是「通用个人/办公 Agent」，Omniwork 是唯一的「创作专家 Agent 协作 OS」，把导演思维/音乐理论/爆款方法论直接注入 Agent 决策链路，而非端到端黑盒生成；②桌面客户端「推理在云端、执行在本地」——MCP/文件读写/浏览器接管/屏幕感知全在本机跑、零上传，关窗口后系统托盘常驻继续跑，是库内少见的「本地执行+云端编排」混合架构；③三层结构化记忆让创作偏好/项目背景持续复利。短板：偏创作者/自媒体/独立开发者，通用办公与代码能力弱于库内通用 Agent；目前主推 Mac 桌面端，深度任务有月度配额；专家 Agent 质量依赖共创方，需实测校准。',
  },
  {
    id: 'mimo-desktop',
    name: '小米 MiMo 桌面客户端（MiMo Desktop）',
    description: '小米桌面AI Agent：多格式素材直读，可交互预览+多Agent会话协作交付。',
    category: 'AI工作台',
    subCategory: '桌面智能体',
    rating: 4.0,
    url: 'https://mimo.mi.com',
    price: '邀测限时免费体验 MiMo-X Pro/Flash Preview；正式订阅/Token Plan 以官网为准',
    features: [
      '多格式素材直读：表格/图片/视频/PDF/录音/压缩包无需预处理，自然语言说目标即拆解执行',
      '可交互预览（非截图）：生成的网页/Office/3D/App 可点击操作、选区局部修改并版本回退',
      '多会话 Agent 协作：多个 session 组成多角色团队，各自独立记忆/工作区/状态自动推进',
      'Smart 调度控成本：按复杂度自动选模型/Agent/框架，同会话缓存命中率最高 99%、跨会话 95%',
      '浏览器+电脑操控：自主开网页、检索、填表、提取素材并自动验证；电脑操控支持录屏回放（海外版）',
      '全模态交付：文档/表格/PPT/网页/图片/音频/视频/3D 模型/App/软件工程一站式产出',
      '小米人车家生态：与手机/汽车/家居设备联动，区别于纯软件桌面 Agent 的硬件入口优势',
      '发布与背书：小米 MiMo 大模型团队 2026-09-08 开放邀测，IT之家/CNMO/北京商报等独立报道'],
    note: '真实体验笔记（基于官网 mimo.mi.com 产品页与新闻页、IT之家/CNMO/北京商报/小米官方微博多源独立报道聚合，赵生尚未亲测）：解决「桌面 Agent 只交文档、碰不到真实工作流」的痛点——小米 MiMo 大模型团队 2026-09-08 刚开放邀测的桌面 AI 应用，把"多格式素材进、可交互成果出"做成核心闭环。差异点：①库内 OpenClaw系/Clairvoyance/Naseem 都是纯软件桌面 Agent，MiMo Desktop 背后有小米"人车家"硬件生态，手机/汽车/家居设备可联动，是少数带硬件入口的桌面 Agent；②"可交互预览"是独门——生成的是能点击、能选区局部改、能版本回退的真页面/真 Office，不是静态截图，区别于库内多数"生成即定稿"工具；③"多会话 Agent 协作"把任务拆给研究/规划/执行/审查多个 session，各自独立记忆与状态自动推进，类似把桌面 Agent 变成一支团队，比库内单 Agent 串行执行更进一步；④Smart 调度把同会话缓存命中率做到最高 99%、跨会话 95%，长任务成本可控，是面向"真干活"的实用主义设计。短板：刚开放邀测、限时免费体验 MiMo-X Preview 模型，稳定性与正式定价待观察；深度能力（电脑操控）海外版先行、国内节奏不明；作为新晋产品尚缺大规模真实用户验证，需赵生后续亲测校准。',
  },
  {
    id: 'qoderwake',
    name: 'QoderWake（阿里数字员工）',
    description: '阿里生产级AI数字员工平台：Waker常驻钉钉/飞书群，被@即接活、7×24在岗，可组队按SOP协作交付。',
    category: 'AI工作台',
    subCategory: '桌面智能体',
    rating: 4.3,
    url: 'https://qoder.com/qoderwake',
    price: 'Mac/Windows 客户端下载免费；企业版/数字员工按组织授权，正式定价以官网为准',
    features: [
      '数字员工（Waker）有工号，常驻钉钉/飞书/企业微信，@即接活、7×24在岗',
      '预置10类岗位（研发/设计/项目/数据/内容/技术支持），一句话建岗',
      'Waker群组：多角色并行、按协作SOP分派、自动交接与互审，全程可追溯',
      'WakerFlow：跑顺的多步流程存为模板，可回滚、可分享给同事复用',
      '四类触发：群@、定时、业务事件（Webhook）、API 均可唤醒',
      '统一任务看板：群聊/定时/事件触发的任务状态一屏可读',
...
,
  {
    id: 'shizai-agent',
    name: '实在Agent（实在智能）',
    description: '实在智能企业级桌面智能体：AI+RPA+屏幕语义理解，无需API操作任意软件。',
    category: 'AI工作台',
    subCategory: '桌面智能体',
    rating: 4.5,
    url: 'https://www.ai-indeed.com/products/agentRpa',
    price: '免费下载体验；企业版/私有化部署按规模授权，具体以官网为准',
    features: [
      'AI+RPA 原生三位一体：TARS大模型(大脑)+ISSUT屏幕语义理解(眼睛)+RPA(双手)',
      '无API依赖：像素级识别ERP/CRM/老旧系统界面，非侵入式跨系统操作',
      '一句话自然语言驱动：自动规划并逐步在电脑上执行任务，实时进度+可干预',
      '信创适配：支持统信UOS、银河麒麟等国产OS，全栈私有化可跑单张T4/国产AI卡',
      '钉钉/飞书无界版+企业运营管理平台，多智能体协作与知识库沉淀',
      '权威背书：2026年7月OSWorld计算机操作智能体榜首(90.2%成功率)、信通院5级、国家专利奖',
    ],
  ...
  {
    id: 'zinley',
    name: 'Zinley（自主个人AI代表）',
    description: '自主个人AI代表：拥有独立手机号/邮箱/电脑，替你接电话、回邮件、跑任务，关键动作需你审批。',
    category: 'AI工作台',
    subCategory: '桌面智能体',
    rating: 4.2,
    url: 'https://zinley.com',
    price: 'Freemium：Free $0（含1个免费号码+2000 credits/月）、Plus $20、Pro $100、Max $200/月；按任务扣 credits（约$0.05/任务）；数据不用于训练。',
    features: [
      '独立手机号与邮箱：客户/候选人可直接呼叫或邮件联系你的 Zinley',
      '自主执行：接电话、回邮件、约时间、跑工作流，仅关键动作需你审批',
      '人脉记忆：记住联系人与互动历史，按你的语气汇报进展',
      '跨设备连续性：Web/桌面/移动统一上下文，可接管你授权的电脑',
      '集成生态：Gmail/Slack/Calendar/Notion/Linear/GitHub/Drive/Figma/Stripe/iMessage/Discord',
      '边界可控：自定义规则，手机即可调整或暂停工作流'
    ],
    note: '真实体验笔记（基于官网 zinley.com 产品页/功能页/定价页，以及 NeoDrop「Zinley 把 AI 接上电话，人类还得审权限」(2026-08)、Product Hunt 中文站、Toolradar/Stork.ai 等多源独立评测聚合，赵生尚未亲测）：解决「AI 只活在聊天框里，而真实的人脉往来——电话、邮件、跟进、约时间——永远得你自己接」的痛点：Zinley 给 Agent 配上了独立手机号、独立邮箱和独立计算环境，让客户/候选人/合作方照常打电话或发邮件就能找到“第二个你”，它接电话、回邮件、排日程、跑工作流，只在需要你拍板时才把你拉回来。差异点：①库内 12+ 桌面智能体（OpenClaw 系/Clairvoyance/Naseem/MiMo Desktop/Highlight AI/Amazon Quick/实在Agent/Open Science 等）本质都是“在你本机或云端执行任务”的执行型 harness，Zinley 的核心创新在「身份层」——它不是帮你操作软件，而是替你存在：有自己的号码和邮箱，别人无需接入任何聊天框就能与之交互，真正被自动化的不是“回答”而是“关系里的来回等待”；②“个人代表/数字分身”这一品类在库内完全空白，与所有屏幕操控型 Agent 形成清晰互补；③人设记忆 + 规则边界做得克制：记住你的人脉与偏好、按你的语气汇报，且关键动作（价格/权利/截止日/对外承诺）默认上报、手机即可暂停，区别于无边界自主 Agent 的失控风险；④明确承诺“永不拿用户数据训练”，对企业用户是硬差异化。短板：信用（credits）计费成本不可预测，高频场景 $20/月可能不够；SOC2 仍“进行中”、长期可靠性与大规模验证尚缺；作为 2026-08 Product Hunt 新发产品，国内通讯基础设施与合规环境与海外不同、暂难直接用；“替你发声”的伦理边界需用户自己把控（官网强调“作为你的 AI 助理而非冒充你本人”）。整体是库内桌面智能体里少见的「自主个人代表」品类，与现有执行型 Agent 形成清晰互补，值得赵生后续亲测校准其“代表你”的边界与成本。'
  }
,
  {
    id: 'tabbit',
    name: 'Tabbit AI 浏览器（美团）',
    description: '美团光年之外团队推出的AI原生智能浏览器，内置Agent可自主上网填表执行任务，支持多模型切换与妙招复用。',
    category: 'AI工作台',
    subCategory: '桌面智能体',
    rating: 4.3,
    url: 'https://www.tabbit.com',
    price: 'Free：永久免费；内置多模型（Kimi K3 / GLM 5.2 / DeepSeek V4 / MiniMax M3 / Doubao-Seed-2.0 / Qwen3.7-Max / LongCat 等）自由切换，新模型上线当天即可接入。',
    features: [
      '原生Agent任务模式：自动拆解复杂办公需求、规划路径、自主访问网页并提取整合信息',
      '多模型协同：内置GLM/DeepSeek/LongCat/Kimi等国内主流模型，标准版可同时调用3个模型对比输出',
      '上下文引用：标签/分组/本地文件一键@，划词与截图即可引用，收藏全文检索',
      '妙招复用：常用提示词存为妙招一键调用，沉淀团队效率',
      '并行多任务：支持同时并行处理多项办公任务，执行过程透明可干预',
      '桌面端支持Windows 10+与macOS，国内官网可下载'
    ],
