...
export default function ToolCard({ tool }: { tool: Tool }) {
  const categoryColors: Record<string, string> = {
    'AI对话助手': 'bg-blue-100 text-blue-700',
    'AI写作工具': 'bg-pink-100 text-pink-700',
    'AI编程开发': 'bg-cyan-100 text-cyan-700',
    'AI图像生成': 'bg-orange-100 text-orange-700',
    'AI视频创作': 'bg-purple-100 text-purple-700',
    'AI办公效率': 'bg-green-100 text-green-700',
    'AI搜索工具': 'bg-indigo-100 text-indigo-700',
    'AI音乐音频': 'bg-rose-100 text-rose-700',
  }
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-lg transition-shadow flex flex-col">
      <div className="flex items-start justify-between mb-3">
        <div>
          ...
          {tool.subCategory && (
            <span className="text-xs text-gray-400 mt-0.5 block">{tool.subCategory}</span>
          )}
        </div>
