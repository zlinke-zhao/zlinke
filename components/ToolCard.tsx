...
export default function ToolCard({ tool }: { tool: Tool }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5 hover:shadow-lg dark:hover:shadow-gray-900/50 transition-all hover:-translate-y-0.5 flex flex-col">
